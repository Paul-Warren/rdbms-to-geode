...
public class CustomerOrderPayload implements Serializable {
	private static final long serialVersionUID = -4434240307681879769L;
	private String id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomerOrderPayload other = (CustomerOrderPayload) obj;
		if (customerId == null) {
	...
	public String toString() {
		return "OrderWrapper [id=" + id + ", customerId=" + customerId + ", shippingAddress=" + shippingAddress
